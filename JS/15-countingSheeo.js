const countSheeps = (sheep) => {
  ...
  for(let i = 0; i<sheep.length; i++){
   ...
   // 4. Jika false(salah) dan error, maka keluarkan hasil atau output yang bernilai undefined atau null.
    return undefined;
  }
 }
 // 5. Setelah itu return 0 sebagai nilai default saat tidak ada nilai yang benar.
 return 0;
 };
